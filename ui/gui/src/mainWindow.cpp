...
/*     /1* spdlog::debug("GUI: Triggered open image list file"); *1/ */
/*     /1* QString imgFilePath = QFileDialog::getOpenFileName( *1/ */
/*     /1*     this, tr("Open Image File List"), mStartPath, "Text (*.txt)"); *1/ */
/*     /1* if (imgFilePath.isEmpty()) *1/ */
/*     /1*     return; *1/ */
/*     /1* auto parentPath = fs::path(imgFilePath.toStdString()).parent_path(); *1/ */
/*     /1* mStartPath = QString::fromStdString(parentPath.string()); *1/ */

/*     /1* mImgFolder = fs::path(imgFilePath.toStdString()); *1/ */
/*     /1* mImages = Images(mImgFolder); *1/ */
/*     /1* openImagesHelper(); *1/ */
/* } */
