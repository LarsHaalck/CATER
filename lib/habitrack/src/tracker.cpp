...
namespace ht
{
void Tracker::track(const Unaries& unaries, const ManualUnaries& manualUnaries,
...
void Tracker::truncatedMaxSum(std::size_t start, std::size_t end,
    ...
    UnarySettings unarySettings, const cv::Mat& pairwiseKernel)
{
    ...
    /*cv::Mat firstUnary;*/
    /*trackingData.getUnaryAt(trackingData.getFirstFrameUsedNum(), firstUnary);*/
    ...
    /*//        cv::minMaxLoc(messageToFactor, &tempMin, &tempMax);*/
    /*// std::cout << "Message to factor:" <<  tempMin << "  -   " << tempMax <<*/
    /*// std::endl;*/

    /*if (numVariables == 1)*/
    /*    messageToNode = messageToFactor;*/

    /*// std::cout << "Num var:" << numVariables << std::endl;*/
    /*cv::Mat tempU = firstUnary.clone();*/
    /*// cv::imshow("first unary", unaries[0]); cv::waitKey(-1);*/
    ...
    /*    // passMessageToFactor(messageToNode, unaries[v], messageToFactor);*/
        /* // std::cout << "Resa dei conti:" << messageToNode.at<float>(418,516) << " + " */
        /* // << log(unaries[v].at<float>(418,516)) << " =" << */
        /* // messageToFactor.at<float>(418,516) << std::endl; */
        /* // cv::minMaxLoc(messageToFactor, &tempMin, &tempMax); */
        /* // std::cout << "In message passer, to node:" << tempMin << "  -   " << tempMax */
        /* // << " exp=" << exp(tempMax) << std::endl; */
    /* } */
    ...
    /*{*/
    /*    maxStates.at<int>(v, 0) = phis[v].at<int>(*/
    /*        maxStates.at<int>(v + 1, 0), maxStates.at<int>(v + 1, 1), 0);*/
    /*    maxStates.at<int>(v, 1) = phis[v].at<int>(*/
    /*        maxStates.at<int>(v + 1, 0), maxStates.at<int>(v + 1, 1), 1);*/
    /*}*/
    /*return maxStates;*/
}
...
void Tracker::passMessageToFactor(const cv::Mat& previousMessageToNode,
