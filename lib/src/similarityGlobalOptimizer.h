...
public:
    ...
    bool operator()(const T* const camParams, const T* const distParams,
        const T* const simVec0, const T* const simVec1, T* errors) const
    {
        (void)camParams;
        (void)distParams;
        ...
        Mat3 homMat0;
        homMat0 << simVec0[0], simVec0[1], simVec0[2],
                  -simVec0[1], simVec0[0], simVec0[5],
                  T(0), T(0), T(1);

        Mat3 homMat1;
        homMat1 << simVec1[0], simVec1[1], simVec1[2],
                  -simVec1[1], simVec1[0], simVec1[5],
                   T(0), T(0), T(1);
